...
export let initState3: GameState = {
    ...
    planetsDistances: [[0,4,6,8,6,4], [4,0,3,6,7,6],[6,3,0,4,6,7],[8,6,4,0,4,6],[6,7,6,4,0,3],[4,6,7,6,3,0]],
    tick: {
        id: 0,
        planets: [
...
export let bots3 = new BotPool(["./bots/win_bot.out", "./bots/win_bot.out", "./bots/win_bot.out"]);